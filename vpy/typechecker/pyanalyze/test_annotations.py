...
class TestCallable(TestNameCheckVisitorBase):
    ...
    def test_asynq_callable_incompatible(self):
        ...
        from vpy.typechecker.pyanalyze.extensions import AsynqCallable
    ...
    def test_asynq_callable(self):
        ...
        from vpy.typechecker.pyanalyze.extensions import AsynqCallable
        from vpy.typechecker.pyanalyze.signature import ELLIPSIS_PARAM, Signature
...
class TestParameterTypeGuard(TestNameCheckVisitorBase):
    ...
    def test_basic(self):
        ...
        from vpy.typechecker.pyanalyze.extensions import ParameterTypeGuard
...
class TestNoReturnGuard(TestNameCheckVisitorBase):
    ...
    def test_basic(self):
        ...
        from vpy.typechecker.pyanalyze.extensions import NoReturnGuard
...
class TestTypeGuard(TestNameCheckVisitorBase):
    ...
    def test(self):
        ...
        from vpy.typechecker.pyanalyze.extensions import TypeGuard
...
class TestCustomCheck(TestNameCheckVisitorBase):
    ...
    def test_reverse_direction(self):
        ...
        from vpy.typechecker.pyanalyze.extensions import CustomCheck
    ...
    def test_no_any(self) -> None:
        ...
        from vpy.typechecker.pyanalyze.extensions import NoAny
...
class TestExternalType(TestNameCheckVisitorBase):
    ...
    def test(self) -> None:
        ...
        from vpy.typechecker.pyanalyze.extensions import ExternalType
