...
class TestAttributes(TestNameCheckVisitorBase):
    ...
    def test_known_value_hook(self):
        from vpy.typechecker.pyanalyze.test_config import SPECIAL_STRING
    ...
    def test_annotated_known(self):
        ...
        from vpy.typechecker.pyanalyze.stacked_scopes import (
            Composite,
            VarnameWithOrigin,
        )
        from vpy.typechecker.pyanalyze.value import CustomCheckExtension
    ...
    def test_module_annotations(self):
        ...
        from vpy.typechecker.pyanalyze import test_attributes
...
class TestHasAttrExtension(TestNameCheckVisitorBase):
    ...
    def test_user_hasattr(self):
        ...
        from vpy.typechecker.pyanalyze.extensions import HasAttrGuard
...
class TestClassAttributeTransformer(TestNameCheckVisitorBase):
    @assert_passes()
    def test(self):
        from vpy.typechecker.pyanalyze.test_config import StringField
